...
import { ChevronLeft, Target, CheckCircle2, PlayCircle, Clock, Trash2 } from 'lucide-react';

const ProjectDetailView = ({ project, tasks, onBack, onToggleTask, onDeleteProject }) => { // Removed currentUser as it was only used for uploads
